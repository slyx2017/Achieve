...
namespace AchieveBLL
{
    ...
    {
        INewsTypeDAL dal = DALFactory.GetNewsTypeDAL();
        public NewsTypeBLL()
        { }
        ...
        public string GetAllNewsTypeInfo(string where)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public NewsTypeEntity GetModel(int id)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<NewsTypeEntity> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<NewsTypeEntity> DataTableToList(DataTable dt)
        {
            List<NewsTypeEntity> modelList = new List<NewsTypeEntity>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                NewsTypeEntity model;
                for (int n = 0; n < rowsCount; n++)
                {
                    model = new NewsTypeEntity();
