...
namespace AchieveDAL
{
    ...
    public class UserRoleDAL : IUserRoleDAL
    {
        ...
        public bool SetRoleSingle(List<UserRoleEntity> role_addList, List<UserRoleEntity> role_deleteList)
        {
        ...
        /// <param name="role_addList">要增加的</param>
        /// <param name="role_deleteList">要删除的</param>
        public bool SetRoleBatch(List<UserRoleEntity> role_addList, List<UserRoleEntity> role_deleteList)
        {
